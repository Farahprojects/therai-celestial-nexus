        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-left">
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-4 mt-4 justify-start">
              <a href="#" className="text-gray-400 hover:text-gray-600 transition-all duration-300 ease-out hover:scale-110 transform">
          ...
          <div>
            <h3 className="font-medium text-gray-900 mb-6 tracking-tight">Legal</h3>
            <ul className="space-y-4 text-sm">
              <li>
                <Link 
                  to="/legal" 
