...
import { User, CalendarDays, Target, Users, ChevronRight, X } from 'lucide-react';
...
interface AstroChartSelectorProps {
  onSelectChart: (chartId: string) => void;
  onClose?: () => void;
}

export const AstroChartSelector: React.FC<AstroChartSelectorProps> = ({ onSelectChart, onClose }) => {
