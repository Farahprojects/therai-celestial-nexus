...
export const faqData: FAQItem[] = [
  ...
  // Account & Billing
  {
    ...
    answer: 'Therai offers three subscription plans: Plus ($8/month) includes unlimited AI conversations, Together Mode (2-person sessions), Premium HD Voice (5 min/month), image generation (1/day), and unlimited folders & sharing. Growth ($10/month) includes everything in Plus but with 10 minutes of voice and 3 images per day. Premium ($18/month) includes everything in Growth plus unlimited voice and image generation, priority support, and early access to new features. All plans are billed monthly and can be canceled anytime.',
  },
  {
    id: 'bill-2',
    category: 'billing',
    question: 'What\'s the difference between Plus, Growth, and Premium?',
    answer: 'Plus ($8/month) gives you unlimited AI conversations, Together Mode, 5 minutes of Premium HD Voice per month, 1 image per day, and unlimited folders & sharing. Growth ($10/month) doubles the voice to 10 minutes and images to 3 per day. Premium ($18/month) includes everything in Growth plus unlimited voice conversations, unlimited image generation, priority support, and early access to new features.',
  },
  {
    id: 'bill-3',
    category: 'billing',
    question: 'How do I subscribe to a plan?',
    answer: 'Navigate to Settings > Billing to view available plans and subscribe. You can choose between Plus, Growth, or Premium and complete your subscription securely through Stripe. Your subscription starts immediately upon payment confirmation.',
  },
  {
    id: 'bill-4',
    category: 'billing',
    question: 'Can I upgrade or downgrade my plan?',
    answer: 'Yes! You can change your subscription at any time. Upgrades from Plus to Growth or Premium take effect immediately, giving you more voice minutes, images, or unlimited features. Downgrades take effect at your next billing cycle. We\'ll prorate any differences.',
  },
  {
    id: 'bill-5',
    category: 'billing',
  ...
  },
  {
    ...
    answer: 'Voice conversation mode is available on all paid plans while it remains in beta. Plus plan ($8/month) includes 5 minutes of Premium HD Voice per month, Growth plan ($10/month) includes 10 minutes per month, and Premium plan ($18/month) includes unlimited voice conversations. Upgrade in Settings > Billing to access voice features.',
  },
  {
    id: 'feat-5',
    category: 'features',
