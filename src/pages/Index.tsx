        ...
        <section className="relative h-screen w-full flex items-center justify-center bg-white overflow-hidden pt-24">
          ...
          <div className="relative z-10 w-full md:px-4 md:container md:mx-auto text-center">
            <motion.div initial={{
              ...
              <h1 className="text-[4rem] md:text-7xl lg:text-8xl font-light text-gray-900 leading-tight flex items-center justify-center gap-x-6 whitespace-nowrap tracking-tight">
                <span>Know</span>
              ...
              <motion.div initial={{
                ...
                <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">Insights that create momentum</p>
                <motion.div initial={{
                  opacity: 0
                }} animate={{
                  opacity: 1
              ...
              <motion.div initial={{
                ...
                <Link to="/signup">
                  <Button size="lg" className="bg-primary text-white px-12 py-6 rounded-full text-lg font-medium hover:bg-primary-hover transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105">
                    Explore
                  </Button>
                </Link>
              </motion.div>
