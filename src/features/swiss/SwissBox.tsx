...
export const SwissBox: React.FC<SwissBoxProps> = ({ onDelete }) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-row flex-1 bg-white w-full min-h-0 mobile-chat-container" style={{ scrollBehavior: 'smooth', overscrollBehavior: 'contain' as React.CSSProperties['overscrollBehavior'] }}>
          ...
          <div className="flex flex-col flex-1 w-full min-w-0 mobile-chat-container">
            <div className="max-w-6xl mx-auto w-full h-full flex flex-col md:border-x border-gray-100">
              ...
              <div className="flex-1 min-h-0 overflow-y-auto" style={{ overflowAnchor: 'none' as React.CSSProperties['overflowAnchor'] }}>
