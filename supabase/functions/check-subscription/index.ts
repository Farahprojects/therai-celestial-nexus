...
// Core subscription check logic - separated from auth concerns
async function checkSubscriptionHandler(authCtx: any): Promise<Response> {
...
Deno.serve(async (req) => {
  return withStandardHandling(req, async () => {
    ...
    return withAuth(req, checkSubscriptionHandler);
  });
});
