...
CREATE INDEX idx_user_images_user_id ON user_images(user_id, created_at DESC);
CREATE INDEX idx_user_images_chat_id ON user_images(chat_id) WHERE chat_id IS NOT NULL;
CREATE INDEX idx_user_images_message_id ON user_images(message_id) WHERE message_id IS NOT NULL;
